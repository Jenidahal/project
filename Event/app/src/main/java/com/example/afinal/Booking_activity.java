...
////                        View alertLayout = inflater.inflate(R.layout.activity_booking_activity, null);
////                Config config = new Config("test_public_key_67697b5bb1194422a5c3c51c963b92ad", model.getId(), model.getTitle(), "", 1000L, new OnCheckOutListener() {
////
////                    @Override
////                    public void onSuccess(HashMap<String, Object> data) {
////                        Log.i("Payment confirmed", data + "");
////                        Log.i("Evento", " data" + data.toString());
////                        Toast.makeText(Booking_activity.this, "Payment Success", Toast.LENGTH_LONG).show();
////                    }
////
////                    @Override
////                    public void onError(String action, String message) {
////                        Log.i("Evento", action + " message: " + message);
////                        Toast.makeText(Booking_activity.this, "Payment Failed Try Again!", Toast.LENGTH_LONG).show();
////                    }
////                });
////                   khalti_button.setCheckOutConfig(config);
////
////                        khalti_button.setCheckOutConfig(config);
////                        AlertDialog.Builder alert = new AlertDialog.Builder(Booking_activity.this);
...
////                                KhaltiCheckOut khaltiCheckOut = new KhaltiCheckOut(Booking_activity.this, config);
////                                khaltiCheckOut.show();
////                            }
////                        });
//
        ...
        mdatabaseRef.push().setValue(file).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    System.out.println("RefData : "+name+"\n"+code+"\n"+phn+"\n"+title);
